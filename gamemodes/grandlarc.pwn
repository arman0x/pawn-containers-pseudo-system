...
stock Player:GetPlayerNameByID(playerid, name[], len = sizeof name)
{
	strcat(name, playerName[playerid], len);
}

stock Player:SetPlayerNameByID(playerid, const name[])
{
    strcat(playerName[playerid], name, MAX_PLAYER_NAME);
}
...
#include "containers/m_container.inc"
//----------------------------------------------------------
...
public OnPlayerConnect(playerid)
{
	...
	Player:SetPlayerNameByID(playerid, name);
...
public OnPlayerSpawn(playerid)
{
	...
	SetPlayerPos(playerid, 1084.2264,-1761.3347,13.3757);
...
public OnGameModeInit()
{
	...
	mysql_set_option(option_id, SERVER_PORT, 3310);
	handle = mysql_connect("127.0.0.1", "root", "", "base", option_id);
	mysql_set_charset("cp1251");
	mysql_log(ALL);

	printf("connection: %d", _:handle);
